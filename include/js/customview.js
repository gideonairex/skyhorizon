...
function selFieldType(id,scrollLayer,bool,blockid) {
	...
	var relatedLayer=document.getElementById("relateddetails_"+blockid);	//for related to ed edited
	
	if (type=='text') {
		lengthLayer.style.visibility="visible"
		decimalLayer.style.visibility="hidden"
		pickListLayer.style.visibility="hidden"
		relatedLayer.style.visibility="hidden"
		...
		pickListLayer.style.visibility="hidden"
		relatedLayer.style.style.visibility="hidden"
