<?php/*+********************************************************************************** * The contents of this file are subject to the vtiger CRM Public License Version 1.0 * ("License"); You may not use this file except in compliance with the License * The Original Code is:  vtiger CRM Open Source * The Initial Developer of the Original Code is vtiger. * Portions created by vtiger are Copyright (C) vtiger. * All Rights Reserved. ************************************************************************************/require_once('data/CRMEntity.php');require_once('data/Tracker.php');class PP extends CRMEntity {	var $db, $log; // Used in class functions of CRMEntity	var $table_name = 'vtiger_pp';	var $table_index= 'ppid';	var $column_fields = Array();	/** Indicator if this is a custom module or standard module */	var $IsCustomModule = true;	/**	 * Mandatory table for supporting custom fields.	 */	var $customFieldTable = Array('vtiger_ppcf', 'ppid');	var $related_tables = Array ('vtiger_ppcf' => Array('ppid'));	/**	 * Mandatory for Saving, Include tables related to this module.	 */	var $tab_name = Array('vtiger_crmentity', 'vtiger_pp', 'vtiger_ppcf');	/**	 * Mandatory for Saving, Include tablename and tablekey columnname here.	 */	var $tab_name_index = Array(		'vtiger_crmentity' => 'crmid',		'vtiger_pp'   => 'ppid',	    'vtiger_ppcf' => 'ppid');		/**	 * Mandatory for Listing (Related listview)	 */	var $list_fields = Array (		/* Format: Field Label => Array(tablename, columnname) */		// tablename should not have prefix 'vtiger_'		'PP No' => Array('pp','pp_no'),'Name' => Array('pp','name'),'Type' => Array('pp','p_type'),'Price' => Array('pp','price')	);	var $list_fields_name = Array(		/* Format: Field Label => fieldname */		'PP No' => 'pp_no','Name' => 'name','Type' => 'p_type','Price' => 'price'	);	// Make the field link to detail view from list view (Fieldname)	var $list_link_field = 'pp_no';	// For Popup listview and UI type support	var $search_fields = Array(		/* Format: Field Label => Array(tablename, columnname) */		// tablename should not have prefix 'vtiger_'		'PP No' => Array('pp','pp_no'),'Name' => Array('pp','name'),'Type' => Array('pp','p_type'),'Price' => Array('pp','price')	);	var $search_fields_name = Array(		/* Format: Field Label => fieldname */		'PP No' => 'pp_no','Name' => 'name','Type' => 'p_type','Price' => 'price'	);	// For Popup window record selection	var $popup_fields = Array('pp_no');	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields	var $sortby_fields = Array();	// For Alphabetical search	var $def_basicsearch_col = 'pp_no';	// Column value to use on detail view record text display	var $def_detailview_recname = 'pp_no';	// Required Information for enabling Import feature	var $required_fields = Array('pp_no'=>1);	// Callback function list during Importing	var $special_functions = Array('set_import_assigned_user');	var $default_order_by = 'pp_no';	var $default_sort_order='ASC';	// Used when enabling/disabling the mandatory fields for the module.	// Refers to vtiger_field.fieldname values.	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'pp_no');
