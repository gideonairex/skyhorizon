<?php/*+********************************************************************************** * The contents of this file are subject to the vtiger CRM Public License Version 1.0 * ("License"); You may not use this file except in compliance with the License * The Original Code is:  vtiger CRM Open Source * The Initial Developer of the Original Code is vtiger. * Portions created by vtiger are Copyright (C) vtiger. * All Rights Reserved. ************************************************************************************/require_once('data/CRMEntity.php');require_once('data/Tracker.php');class DisbursementLogs extends CRMEntity {	var $db, $log; // Used in class functions of CRMEntity	var $table_name = 'vtiger_disbursementlogs';	var $table_index= 'disbursementlogsid';	var $column_fields = Array();	/** Indicator if this is a custom module or standard module */	var $IsCustomModule = true;	/**	 * Mandatory table for supporting custom fields.	 */	var $customFieldTable = Array('vtiger_disbursementlogscf', 'disbursementlogsid');	var $related_tables = Array ('vtiger_disbursementlogscf' => Array('disbursementlogsid'));	/**	 * Mandatory for Saving, Include tables related to this module.	 */	var $tab_name = Array('vtiger_crmentity', 'vtiger_disbursementlogs', 'vtiger_disbursementlogscf');	/**	 * Mandatory for Saving, Include tablename and tablekey columnname here.	 */	var $tab_name_index = Array(		'vtiger_crmentity' => 'crmid',		'vtiger_disbursementlogs'   => 'disbursementlogsid',	    'vtiger_disbursementlogscf' => 'disbursementlogsid');	/**	 * Mandatory for Listing (Related listview)	 */	var $list_fields = Array (		/* Format: Field Label => Array(tablename, columnname) */		// tablename should not have prefix 'vtiger_'		'Disbursement Log No' => Array('disbursementlogs','disbursement_no'),'AP No' => Array('disbursementlogs','ap_no'),'Amount ' => Array('disbursementlogs','amount'),'EWT' => Array('disbursementlogs','ewt'),'Currency' => Array('disbursementlogs','dl_currency')	);	var $list_fields_name = Array(		/* Format: Field Label => fieldname */		'Disbursement Log No' => 'disbursement_no','AP No' => 'ap_no','Amount ' => 'amount','EWT' => 'ewt','Currency' => 'dl_currency'	);	// Make the field link to detail view from list view (Fieldname)	var $list_link_field = 'disbursement_no';	// For Popup listview and UI type support	var $search_fields = Array(		/* Format: Field Label => Array(tablename, columnname) */		// tablename should not have prefix 'vtiger_'		'Disbursement Log No' => Array('disbursementlogs','disbursement_no'),'AP No' => Array('disbursementlogs','ap_no'),'Amount ' => Array('disbursementlogs','amount'),'EWT' => Array('disbursementlogs','ewt'),'Currency' => Array('disbursementlogs','dl_currency')	);	var $search_fields_name = Array(		/* Format: Field Label => fieldname */		'Disbursement Log No' => 'disbursement_no','AP No' => 'ap_no','Amount ' => 'amount','EWT' => 'ewt','Currency' => 'dl_currency'	);	// For Popup window record selection	var $popup_fields = Array('disbursement_no');	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields	var $sortby_fields = Array();	// For Alphabetical search	var $def_basicsearch_col = 'disbursement_no';	// Column value to use on detail view record text display	var $def_detailview_recname = 'disbursement_no';	// Required Information for enabling Import feature	var $required_fields = Array('disbursement_no'=>1);	// Callback function list during Importing	var $special_functions = Array('set_import_assigned_user');	var $default_order_by = 'disbursement_no';	var $default_sort_order='ASC';	// Used when enabling/disabling the mandatory fields for the module.	// Refers to vtiger_field.fieldname values.	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'disbursement_no');
