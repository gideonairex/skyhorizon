<?php/*+********************************************************************************** * The contents of this file are subject to the vtiger CRM Public License Version 1.0 * ("License"); You may not use this file except in compliance with the License * The Original Code is:  vtiger CRM Open Source * The Initial Developer of the Original Code is vtiger. * Portions created by vtiger are Copyright (C) vtiger. * All Rights Reserved. ************************************************************************************/require_once('data/CRMEntity.php');require_once('data/Tracker.php');class Proposal extends CRMEntity {	var $db, $log; // Used in class functions of CRMEntity	var $table_name = 'vtiger_proposal';	var $table_index= 'proposalid';	var $column_fields = Array();	/** Indicator if this is a custom module or standard module */	var $IsCustomModule = true;	/**	 * Mandatory table for supporting custom fields.	 */	var $customFieldTable = Array('vtiger_proposalcf', 'proposalid');	var $related_tables = Array ('vtiger_proposalcf' => Array('proposalid'));	/**	 * Mandatory for Saving, Include tables related to this module.	 */	var $tab_name = Array('vtiger_crmentity', 'vtiger_proposal', 'vtiger_proposalcf');	/**	 * Mandatory for Saving, Include tablename and tablekey columnname here.	 */	var $tab_name_index = Array(		'vtiger_crmentity' => 'crmid',		'vtiger_proposal'   => 'proposalid',	    'vtiger_proposalcf' => 'proposalid');		/**	 * Mandatory for Listing (Related listview)	 */	var $list_fields = Array (		/* Format: Field Label => Array(tablename, columnname) */		// tablename should not have prefix 'vtiger_'		'Proposal No.' => Array('proposal','proposal_no'),'Customer' => Array('proposal','customer'),'Proposed Bill' => Array('proposal','proposed_bill'),'Package' => Array('proposal','package')	);	var $list_fields_name = Array(		/* Format: Field Label => fieldname */		'Proposal No.' => 'proposal_no','Customer' => 'customer','Proposed Bill' => 'proposed_bill','Package' => 'package'	);	// Make the field link to detail view from list view (Fieldname)	var $list_link_field = 'proposal_no';	// For Popup listview and UI type support	var $search_fields = Array(		/* Format: Field Label => Array(tablename, columnname) */		// tablename should not have prefix 'vtiger_'		'Proposal No.' => Array('proposal','proposal_no'),'Customer' => Array('proposal','customer'),'Proposed Bill' => Array('proposal','proposed_bill'),'Package' => Array('proposal','package')	);	var $search_fields_name = Array(		/* Format: Field Label => fieldname */		'Proposal No.' => 'proposal_no','Customer' => 'customer','Proposed Bill' => 'proposed_bill','Package' => 'package'	);	// For Popup window record selection	var $popup_fields = Array('proposal_no');	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields	var $sortby_fields = Array();	// For Alphabetical search	var $def_basicsearch_col = 'proposal_no';	// Column value to use on detail view record text display	var $def_detailview_recname = 'proposal_no';	// Required Information for enabling Import feature	var $required_fields = Array('proposal_no'=>1);	// Callback function list during Importing	var $special_functions = Array('set_import_assigned_user');	var $default_order_by = 'proposal_no';	var $default_sort_order='ASC';	// Used when enabling/disabling the mandatory fields for the module.	// Refers to vtiger_field.fieldname values.	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'proposal_no');
