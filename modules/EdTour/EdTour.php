<?php/*+********************************************************************************** * The contents of this file are subject to the vtiger CRM Public License Version 1.0 * ("License"); You may not use this file except in compliance with the License * The Original Code is:  vtiger CRM Open Source * The Initial Developer of the Original Code is vtiger. * Portions created by vtiger are Copyright (C) vtiger. * All Rights Reserved. ************************************************************************************/require_once('data/CRMEntity.php');require_once('data/Tracker.php');class EdTour extends CRMEntity {	var $db, $log; // Used in class functions of CRMEntity	var $table_name = 'vtiger_edtour';	var $table_index= 'edtourid';	var $column_fields = Array();	/** Indicator if this is a custom module or standard module */	var $IsCustomModule = true;	/**	 * Mandatory table for supporting custom fields.	 */	var $customFieldTable = Array('vtiger_edtourcf', 'edtourid');	var $related_tables = Array ('vtiger_edtourcf' => Array('edtourid'));	/**	 * Mandatory for Saving, Include tables related to this module.	 */	var $tab_name = Array('vtiger_crmentity', 'vtiger_edtour', 'vtiger_edtourcf');	/**	 * Mandatory for Saving, Include tablename and tablekey columnname here.	 */	var $tab_name_index = Array(		'vtiger_crmentity' => 'crmid',		'vtiger_edtour'   => 'edtourid',	    'vtiger_edtourcf' => 'edtourid');		/**	 * Mandatory for Listing (Related listview)	 */	var $list_fields = Array (		/* Format: Field Label => Array(tablename, columnname) */		// tablename should not have prefix 'vtiger_'		'Ed Tour No' => Array('edtour','edtour_no'),'Name' => Array('edtour','name'),'Price' => Array('edtour','price')	);	var $list_fields_name = Array(		/* Format: Field Label => fieldname */		'Ed Tour No' => 'edtour_no','Name' => 'name','Price' => 'price'	);	// Make the field link to detail view from list view (Fieldname)	var $list_link_field = 'edtour_no';	// For Popup listview and UI type support	var $search_fields = Array(		/* Format: Field Label => Array(tablename, columnname) */		// tablename should not have prefix 'vtiger_'		'Ed Tour No' => Array('edtour','edtour_no'),'Name' => Array('edtour','name'),'Price' => Array('edtour','price')	);	var $search_fields_name = Array(		/* Format: Field Label => fieldname */		'Ed Tour No' => 'edtour_no','Name' => 'name','Price' => 'price'	);	// For Popup window record selection	var $popup_fields = Array('edtour_no');	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields	var $sortby_fields = Array();	// For Alphabetical search	var $def_basicsearch_col = 'edtour_no';	// Column value to use on detail view record text display	var $def_detailview_recname = 'edtour_no';	// Required Information for enabling Import feature	var $required_fields = Array('edtour_no'=>1);	// Callback function list during Importing	var $special_functions = Array('set_import_assigned_user');	var $default_order_by = 'edtour_no';	var $default_sort_order='ASC';	// Used when enabling/disabling the mandatory fields for the module.	// Refers to vtiger_field.fieldname values.	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'edtour_no');
