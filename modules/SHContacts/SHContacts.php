<?php/*+********************************************************************************** * The contents of this file are subject to the vtiger CRM Public License Version 1.0 * ("License"); You may not use this file except in compliance with the License * The Original Code is:  vtiger CRM Open Source * The Initial Developer of the Original Code is vtiger. * Portions created by vtiger are Copyright (C) vtiger. * All Rights Reserved. ************************************************************************************/require_once('data/CRMEntity.php');require_once('data/Tracker.php');class SHContacts extends CRMEntity {	var $db, $log; // Used in class functions of CRMEntity	var $table_name = 'vtiger_shcontacts';	var $table_index= 'shcontactsid';	var $column_fields = Array();	/** Indicator if this is a custom module or standard module */	var $IsCustomModule = true;	/**	 * Mandatory table for supporting custom fields.	 */	var $customFieldTable = Array('vtiger_shcontactscf', 'shcontactsid');	var $related_tables = Array ('vtiger_shcontactscf' => Array('shcontactsid'));	/**	 * Mandatory for Saving, Include tables related to this module.	 */	var $tab_name = Array('vtiger_crmentity', 'vtiger_shcontacts', 'vtiger_shcontactscf');	/**	 * Mandatory for Saving, Include tablename and tablekey columnname here.	 */	var $tab_name_index = Array(		'vtiger_crmentity' => 'crmid',		'vtiger_shcontacts'   => 'shcontactsid',	    'vtiger_shcontactscf' => 'shcontactsid');		/**	 * Mandatory for Listing (Related listview)	 */	var $list_fields = Array (		/* Format: Field Label => Array(tablename, columnname) */		// tablename should not have prefix 'vtiger_'		'Contact No.' => Array('shcontacts','contact_no'),'First Name' => Array('shcontacts','firstname'),'Last Name' => Array('shcontacts','lastname'),'Mobile No.' => Array('shcontacts','mobile_no'),'Email' => Array('shcontacts','email'),'Address' => Array('shcontacts','address')	);	var $list_fields_name = Array(		/* Format: Field Label => fieldname */		'Contact No.' => 'contact_no','First Name' => 'firstname','Last Name' => 'lastname','Mobile No.' => 'mobile_no','Email' => 'email','Address' => 'address'	);	// Make the field link to detail view from list view (Fieldname)	var $list_link_field = 'contact_no';	// For Popup listview and UI type support	var $search_fields = Array(		/* Format: Field Label => Array(tablename, columnname) */		// tablename should not have prefix 'vtiger_'		'Contact No.' => Array('shcontacts','contact_no'),'First Name' => Array('shcontacts','firstname'),'Last Name' => Array('shcontacts','lastname'),'Mobile No.' => Array('shcontacts','mobile_no'),'Email' => Array('shcontacts','email'),'Address' => Array('shcontacts','address')	);	var $search_fields_name = Array(		/* Format: Field Label => fieldname */		'Contact No.' => 'contact_no','First Name' => 'firstname','Last Name' => 'lastname','Mobile No.' => 'mobile_no','Email' => 'email','Address' => 'address'	);	// For Popup window record selection	var $popup_fields = Array('contact_no');	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields	var $sortby_fields = Array();	// For Alphabetical search	var $def_basicsearch_col = 'contact_no';	// Column value to use on detail view record text display	var $def_detailview_recname = 'contact_no';	// Required Information for enabling Import feature	var $required_fields = Array('contact_no'=>1);	// Callback function list during Importing	var $special_functions = Array('set_import_assigned_user');	var $default_order_by = 'contact_no';	var $default_sort_order='ASC';	// Used when enabling/disabling the mandatory fields for the module.	// Refers to vtiger_field.fieldname values.	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'contact_no');
