							...
							<tr>
								...
								<td class="colHeader small"  id = "blockid"_{$entries.blockid} colspan="2" align='right'> 
									...
									{/if}	
										...
										<img src="{'nextIXplus.gif'|@vtiger_imageurl:$THEME}" border="0" style="cursor:pointer;"  onclick="fnvshobj(this,'addfield_{$entries.blockid}_^_^Y'); " alt="ADD FIELD" title="ADD FIELD"/>&nbsp;&nbsp;												
										<!-- ed end-->
									{if $entries.hascustomtable && $entries.blockid neq $COMMENTSECTIONID && $entries.blockid neq $SOLUTIONBLOCKID }
										<img src="{'plus_layout.gif'|@vtiger_imageurl:$THEME}" border="0" style="cursor:pointer;"  onclick="fnvshobj(this,'addfield_{$entries.blockid}_^_^X'); " alt="{$MOD.LBL_ADD_CUSTOMFIELD}" title="{$MOD.LBL_ADD_CUSTOMFIELD}"/>&nbsp;&nbsp;
									{/if}
											<!-- for adding customfield -->
												<div id="addfield_{$entries.blockid}" style="display:none; position:absolute; width:500px;" class="layerPopup">
	  												...
	  												<table width="100%" border="0" cellpadding="5" cellspacing="0" class="layerHeadingULine">
														<tr>
															<!-- ed edited for not custom field -->
															<td id="addfield_{$entries.blockid}_NCustom" style="display:none" width="60%" align="left" class="layerPopupHeading">Create Field
															</td>	
															<!-- ed edited end-->
															<td id="addfield_{$entries.blockid}_Custom" width="60%" align="left" class="layerPopupHeading">{$MOD.LBL_ADD_FIELD}
															</td>
																	...
																	<tr>
																					...
																					<td>
																						<div name="cfcombo" id="cfcombo" class="small"  style="width:205px; height:150px; overflow-y:auto ;overflow-x:hidden ;overflow:auto; border:1px  solid #CCCCCC ;">
																							<table>
																								...
																								<tr><td align="left"><a id="field14_{$entries.blockid}"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url({'text.gif'|@vtiger_imageurl:$THEME});" 		onclick = "makeFieldSelected(this,'relation',{$entries.blockid});"> Relation </a></td></tr>
																							</table>
																						</div>	
																					</td>
																				</tr>
																		...
																		<td width="50%">
																			<table width="100%" border="0" cellpadding="5" cellspacing="0">
																				...
																				<tr id="relateddetails_{$entries.blockid}" style="visibility:hidden;">
																					<td class="dataLabel" nowrap="nowrap" align="right" valign="top"><b>Related To</b>
																					</td>
																					<td align="left" width="70%">
																					<select id="fldRelation_{$entries.blockid}" class="txtBox">
																						{foreach from=$POSSIBLE_RELATION item=option key=k}
													...
													<table border="0" cellspacing="0" cellpadding="5" width="100%" class="layerPopupTransport">
														<tr>
															<td align="center">
																<!-- ed edited for not custom field -->
																<input id="addfield_{$entries.blockid}_saveNCustom" style="display:none" type="button" name="save" value=" {$APP.LBL_SAVE_BUTTON_LABEL}" class="crmButton small save"  onclick = "getCreateFieldForm('{$MODULE}','{$entries.blockid}','add');"/>&nbsp;
																<!-- ed edited end-->
																<input id="addfield_{$entries.blockid}_saveCustom" type="button" name="save" value=" {$APP.LBL_SAVE_BUTTON_LABEL}" class="crmButton small save"  onclick = "getCreateCustomFieldForm('{$MODULE}','{$entries.blockid}','add');"/>&nbsp;
