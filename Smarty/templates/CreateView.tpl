							...
							<!-- General details -->
								<table border=0 cellspacing=0 cellpadding=0 width="100%" class="small">
								   <tr>
									<td  colspan=4 style="padding:5px">
									   <div align="center">
										...
										{else}
											<input id = "saveFlow" title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="crmbutton small save" type="submit" name="button" value="  {$APP.LBL_SAVE_BUTTON_LABEL}  " style="width:70px;display:none" >
										{/if}
								   ...
								   {foreach key=header item=data from=$BASBLOCKS}
										...
										{/if}
										{* ed edited end *}
									<table border=0 cellspacing=0 cellpadding=0 width=100% id="{$header}" {$hidingStatBlock}>
								   ...
								   {if $header eq 'General Information' && $MODULE eq 'House'}
									 <tr>
