...
//	getObj('search_text').value = '';
	...
	{ldelim}
		...
		case 7:
			getObj('mail_fldrname').innerHTML = '<b>{'LBL_TO_HOMEOWNER'|@getTranslatedString:$MODULE}</b>';
			folder='<b>{'LBL_TO_HOMEOWNER'|@getTranslatedString:$MODULE}</b>';
	{rdelim}
...
<!-- Sent mail -->
								...
								<ul style="list-style-type:none;margin-left:10px;margin-top:5px;padding:2px">
									...
									<li><img src="{'folder1.gif'|@vtiger_imageurl:$THEME}" align="absmiddle" />&nbsp;&nbsp;
									<a href="javascript:;" onClick="ShowFolders(7)" class="webMnu">{'LBL_TO_HOMEOWNER'|@getTranslatedString:$MODULE}</a>&nbsp;
									</li>
									-->
								</ul>