...
<html>
<head>
	<title>{$USER} - {$MODULE_NAME|@getTranslatedString:$MODULE_NAME}</title>
...
<TABLE border=0 cellspacing=0 cellpadding=0 width=100% class="small">
	<tr>
		<td valign=top align=left><!-- gideon <img src="test/logo/{$LOGO}" alt="{$LOGO}" title="{$LOGO}" border=0 style="width: 15em;height: 4.2em;"> --> </td>
