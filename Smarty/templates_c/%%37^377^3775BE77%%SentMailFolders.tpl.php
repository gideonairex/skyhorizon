<?php /* Smarty version 2.6.18, created on 2014-10-21 09:47:58
         compiled from SentMailFolders.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'getTranslatedString', 'SentMailFolders.tpl', 19, false),array('modifier', 'vtiger_imageurl', 'SentMailFolders.tpl', 112, false),)), $this); ?>
...
//	getObj('search_text').value = '';
	switch(folderid)
	{
		...
		case 7:
			getObj('mail_fldrname').innerHTML = '<b><?php echo getTranslatedString('LBL_TO_HOMEOWNER', $this->_tpl_vars['MODULE']); ?>
</b>';
			folder='<b><?php echo getTranslatedString('LBL_TO_HOMEOWNER', $this->_tpl_vars['MODULE']); ?>
</b>';
	}
...
" align="absmiddle" />&nbsp;&nbsp;
									...
									<li><img src="<?php echo vtiger_imageurl('folder1.gif', $this->_tpl_vars['THEME']); ?>
" align="absmiddle" />&nbsp;&nbsp;
									<a href="javascript:;" onClick="ShowFolders(7)" class="webMnu"><?php echo getTranslatedString('LBL_TO_HOMEOWNER', $this->_tpl_vars['MODULE']); ?>
</a>&nbsp;
									</li>
									-->
								</ul>