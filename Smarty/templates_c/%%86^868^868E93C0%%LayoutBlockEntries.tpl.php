<?php /* Smarty version 2.6.18, created on 2014-08-18 16:10:38
...
');" />
										...
										<img src="<?php echo vtiger_imageurl('nextIXplus.gif', $this->_tpl_vars['THEME']); ?>
" border="0" style="cursor:pointer;"  onclick="fnvshobj(this,'addfield_<?php echo $this->_tpl_vars['entries']['blockid']; ?>
_^_^Y'); " alt="ADD FIELD" title="ADD FIELD"/>&nbsp;&nbsp;												
										<!-- ed end-->
...
" border="0" style="cursor:pointer;"  onclick="fnvshobj(this,'addfield_<?php echo $this->_tpl_vars['entries']['blockid']; ?>
_^_^X'); " alt="<?php echo $this->_tpl_vars['MOD']['LBL_ADD_CUSTOMFIELD']; ?>
...
" style="display:none; position:absolute; width:500px;" class="layerPopup">
	  												...
	  												<table width="100%" border="0" cellpadding="5" cellspacing="0" class="layerHeadingULine">
														<tr>
															<!-- ed edited for not custom field -->
															<td id="addfield_<?php echo $this->_tpl_vars['entries']['blockid']; ?>
_NCustom" style="display:none" width="60%" align="left" class="layerPopupHeading">Create Field
															</td>	
															<!-- ed edited end-->
															<td id="addfield_<?php echo $this->_tpl_vars['entries']['blockid']; ?>
_Custom" width="60%" align="left" class="layerPopupHeading"><?php echo $this->_tpl_vars['MOD']['LBL_ADD_FIELD']; ?>
...
"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url(<?php echo vtiger_imageurl('time.PNG', $this->_tpl_vars['THEME']); ?>
																								...
																								<tr><td align="left"><a id="field14_<?php echo $this->_tpl_vars['entries']['blockid']; ?>
"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url(<?php echo vtiger_imageurl('text.gif', $this->_tpl_vars['THEME']); ?>
);" 		onclick = "makeFieldSelected(this,'relation',<?php echo $this->_tpl_vars['entries']['blockid']; ?>
);"> Relation </a></td></tr>
																							</table>
																						</div>	
																					</td>
...
" rows="10" class="txtBox" ></textarea>
																				...
																				<tr id="relateddetails_<?php echo $this->_tpl_vars['entries']['blockid']; ?>
" style="visibility:hidden;">
																					<td class="dataLabel" nowrap="nowrap" align="right" valign="top"><b>Related To</b>
																					</td>
																					<td align="left" width="70%">
																					<select id="fldRelation_<?php echo $this->_tpl_vars['entries']['blockid']; ?>
" class="txtBox">
																						<?php $_from = $this->_tpl_vars['POSSIBLE_RELATION']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['k'] => $this->_tpl_vars['option']):
?>
...
"><?php echo $this->_tpl_vars['option']; ?>
													...
													<table border="0" cellspacing="0" cellpadding="5" width="100%" class="layerPopupTransport">
														<tr>
															<td align="center">
																<!-- ed edited for not custom field -->
																<input id="addfield_<?php echo $this->_tpl_vars['entries']['blockid']; ?>
_saveNCustom" style="display:none" type="button" name="save" value=" <?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
" class="crmButton small save"  onclick = "getCreateFieldForm('<?php echo $this->_tpl_vars['MODULE']; ?>
','<?php echo $this->_tpl_vars['entries']['blockid']; ?>
','add');"/>&nbsp;
																<!-- ed edited end-->
																<input id="addfield_<?php echo $this->_tpl_vars['entries']['blockid']; ?>
_saveCustom" type="button" name="save" value=" <?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
